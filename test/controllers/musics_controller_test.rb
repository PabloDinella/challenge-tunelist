...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { album_id: @music.album_id, author: @music.author, kind: @music.kind, title: @music.title }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { album_id: @music.album_id, author: @music.author, kind: @music.kind, title: @music.title }
    assert_redirected_to music_path(assigns(:music))
  end
